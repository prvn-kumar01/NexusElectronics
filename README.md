...
<p align="center">
  <a href="https://fusion-ecommerce-app.vercel.app/" target="_blank">
    <img src="docs/logo.png" alt="Nexus Electronics Logo" style="border-radius: 10px" width="35%"/>
  </a>
</p>
...
The application is deployed live on Vercel. You can access it at the following URL: **[Nexus Electronics App](https://fusion-ecommerce-app.vercel.app).**

The **primary** backend server is deployed on Vercel and can be accessed at the following URL: **[Nexus Electronics API](https://fusion-electronics-api.vercel.app/)**.

The **backup** backend server is deployed on Render and can be accessed at the following URL: **[Nexus Electronics API](https://fusion-electronics-api.vercel.app/).**
...
<p align="center">
    <img src="docs/home-ui.png" alt="Nexus Electronics Homepage" style="border-radius: 10px" width="100%"/>
</p>

### Recommended Products (based on user interaction)

<p align="center">
    <img src="docs/recommended-products-ui.png" alt="Nexus Electronics Recommended Products" style="border-radius: 10px" width="100%"/>
</p>

### Full Product List

<p align="center">
    <img src="docs/products-ui.png" alt="Nexus Electronics Products List" style="border-radius: 10px" width="100%"/>
</p>

### Search Results

<p align="center">
    <img src="docs/search-results-ui.png" alt="Nexus Electronics Search Results" style="border-radius: 10px" width="100%"/>
</p>

### Product Details Page

<p align="center">
    <img src="docs/product-details-ui.png" alt="Nexus Electronics Product Details Page" style="border-radius: 10px" width="100%"/>
</p>

### Cart Page

<p align="center">
    <img src="docs/cart-ui.png" alt="Nexus Electronics Cart Page" style="border-radius: 10px" width="100%"/>
</p>

### Checkout Page

<p align="center">
    <img src="docs/checkout-ui.png" alt="Nexus Electronics Checkout Page" style="border-radius: 10px" width="100%"/>
</p>

### Support Page

<p align="center">
    <img src="docs/support-ui.png" alt="Nexus Electronics Support Page" style="border-radius: 10px" width="100%"/>
</p>

### About Page

<p align="center">
    <img src="docs/about-ui.png" alt="Nexus Electronics About Page" style="border-radius: 10px" width="100%"/>
</p>

### Order Confirmation

<p align="center">
    <img src="docs/order-ui.png" alt="Nexus Electronics Order Success Page" style="border-radius: 10px" width="100%"/>
</p>

### Order Tracking

<p align="center">
    <img src="docs/order-tracking-ui.png" alt="Nexus Electronics Order Tracking Page" style="border-radius: 10px" width="100%"/>
</p>

### Shipping & Returns

<p align="center">
    <img src="docs/shipping-ui.png" alt="Nexus Electronics Shipping & Returns Page" style="border-radius: 10px" width="100%"/>
</p>

### Terms of Service

<p align="center">
    <img src="docs/terms-ui.png" alt="Nexus Electronics Terms of Service Page" style="border-radius: 10px" width="100%"/>
</p>

### Privacy Policy

<p align="center">
    <img src="docs/privacy-ui.png" alt="Nexus Electronics Privacy Policy Page" style="border-radius: 10px" width="100%"/>
</p>

### Login Page

<p align="center">
    <img src="docs/login-ui.png" alt="Nexus Electronics Login Page" style="border-radius: 10px" width="100%"/>
</p>

### Register Page

<p align="center">
    <img src="docs/register-ui.png" alt="Nexus Electronics Register Page" style="border-radius: 10px" width="100%"/>
</p>

### Forgot Password Page

<p align="center">
    <img src="docs/forgot-password-ui.png" alt="Nexus Electronics Forgot Password Page" style="border-radius: 10px" width="100%"/>
</p>

### Reset Password Page

<p align="center">
    <img src="docs/reset-password-ui.png" alt="Nexus Electronics Reset Password Page" style="border-radius: 10px" width="100%"/>
</p>

### Footer

<p align="center">
    <img src="docs/footer.png" alt="Nexus Electronics Footer" style="border-radius: 10px" width="100%"/>
</p>
...
- **Product Recommendations & AI (via Groq & Vector Databases):**
    - **Vector Search:** Similar products displayed using Pinecone/Weaviate.
    - **Automated SEO Descriptions:** Generates punchy marketing blurbs for products dynamically using Groq.
    - **AI Review Summarization:** Analyzes customer reviews and generates a concise list of Pros & Cons automatically.
    - **Smart Bundling:** Context-aware "Complete the Setup" accessory recommendations via LLM logic.
...
Nexus Electronics supports a wide range of deployment platforms, including Vercel, Render, AWS, and more. You can deploy both the frontend and backend servers to your preferred cloud provider.
...
Thank you for exploring **Nexus Electronics - a MERN Stack E-commerce Application**! If you have any questions or feedback, feel free to reach out or open an issue.
