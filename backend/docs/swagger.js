...
const swaggerDefinition = {
  openapi: '3.0.0',
  info: {
    title: 'Nexus E-Commerce Backend APIs',
    version: '1.1.0',
    description:
      'API documentation for the Nexus E-Commerce backend server. This documentation provides detailed information on all available endpoints for managing products, users, authentication, and more.',
    termsOfService: 'https://mern-stack-ecommerce-app-nine.vercel.app',
    contact: {
      name: 'Nexus E-Commerce Website',
  ...
  servers: [
    {
      url: 'https://nexus-electronics-api.vercel.app',
...
<head>
  <meta charset="UTF-8">
  <title>Nexus E-Commerce API Docs</title>
