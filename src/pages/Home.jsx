...
const testimonials = [
  {
    ...
    quote: "Nexus Electronics curates gear I didn’t even know I needed. The quality and delivery speed are unmatched.",
  },
  {
    name: 'Morgan Patel',
    ...
    <Box sx={{ my: { xs: 2, md: 4 } }}>
      ...
      <Container maxWidth="xl">
        ...
        <Box sx={{ mt: 10 }}>
          ...
          <Typography variant="body1" color="text.secondary" textAlign="center" sx={{ mb: 4 }}>
            Real stories from customers building their dream setups with Nexus Electronics.
          </Typography>
          <Grid container spacing={3}>
