    ...
    <Container maxWidth="md" sx={{ py: { xs: 6, md: 10 } }}>
      <Stack spacing={3} alignItems="center" textAlign="center" sx={{ mb: 4 }}>
        ...
        <Typography variant="body1" color="text.secondary" sx={{ maxWidth: 680 }}>
          We collect only what we need to ship exceptional products and continuously improve the Nexus experience. The details below outline exactly how it
          works.
        </Typography>
      ...
      <Paper elevation={0} sx={{ p: { xs: 3, md: 5 }, borderRadius: 4 }}>
        <Stack spacing={5}>
          ...
          <Stack spacing={2}>
            ...
            <Typography variant="body2" color="text.secondary">
              Email privacy@nexuselectronics.io with the subject “Data Request” and our privacy desk will validate your identity before fulfilling the request
              within 30 days.
            </Typography>
          </Stack>
          ...
          <Stack spacing={2}>
            <Typography variant="body2" color="text.secondary">
              Questions about this policy? Reach out through the Support Centre or email privacy@nexuselectronics.io so we can help.
            </Typography>
